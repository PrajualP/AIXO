...
def canComputerwin():
    #computerwinningchancelefttoright
    additionresult,tempi,tempj=0,0,0
    #print("checking if it has the chance of winning left to right")
    for i in range(3):
        additionresult=0
        for j in range(3):
            additionresult=additionresult+Board[i][j]
        ...
        if additionresult==-2:
            return tempi,tempj
    #print("No")
    #computerwinningchancetoptobottom
    additionresult,tempi,tempj=0,0,0
    #print("checking if it has the chance of winning top to bottom")
    for j in range(3):
        additionresult=0
        for i in range(3):
            additionresult=additionresult+Board[i][j]
        ...
        if additionresult==-2:
            return tempi,tempj
    #print("NO")
    #computerwinningchancediagonal
    additionresult,tempi,tempj=0,0,0
    #print("checking if it has the chance of winning diagonal")
    for i in range(3):
            additionresult=additionresult+Board[i][i]
            if Board[i][i]==0:
                tempi=i
...
def computerMove():
    ...
    #print([i,j])
    if Board[i][j] == 0:
        print("The chosen iandj are ...",i,j,end='\n')
        Board[i][j]=-1
